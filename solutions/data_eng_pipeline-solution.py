...
dataEngStep1="gs://s8s_code_bucket-"+projectNbr+"/dataeng/data_eng_dag_step_1.py"
dataEngStep2="gs://s8s_code_bucket-"+projectNbr+"/dataeng/data_eng_dag_step_2.py"
dataEngStep3="gs://s8s_code_bucket-"+projectNbr+"/dataeng/data_eng_dag_step_3.py"
# }}
...
s8sSparkBatchConfigStep3 = {
    "pyspark_batch": {
        "main_python_file_uri": dataEngStep3,
        "args": batchScoringArguments,
        "jar_file_uris": [ bqConnectorJarUri ]
    },
    "runtime_config": {
...
with models.DAG(
    ...
    customerChurnDataEngStep3 = DataprocCreateBatchOperator(
    ...
    customerChurnDataEngStep1 >> customerChurnDataEngStep2 >> customerChurnDataEngStep3
